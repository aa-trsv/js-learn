...
// Эта функция принимает на вход то, что проверяется (валидируется) и возвращает массив или объект с ошибками. Если объект пустой, значит ошибок нет.
//
// solution.js
...
console.log(validator.validate('qwerty')); // { minLength: 'too small' }v

const validator2 = new PasswordValidator({ containNumbers: true });
console.log(validator2.validate('qwyui'));
console.log(validator2.validate('qwerty12341234'));
